...
class SportradarSoccerAPI(object):
    ...
    def __init__(self, api_key, api='soccer-extended', level='trial', version='v4', language='en', api_format='json', timeout=120, sleep_time=1.1) -> None:
    ...
    def get_competitions(self):
        ...
        competitions = utils._format_competitions(response)
    ...
    def get_seasons(self):
        ...
        seasons = utils._format_seasons(response)
    ...
    def get_season_summary(self, season_id: str):
        ...
        season_events_summaries = utils._format_season_summary(response)
    ...
    def get_season_players_statistics(self, season_id: str):
        response = self._make_request(f"seasons/{season_id}/summaries")
        season_players_statistics = utils._format_season_players_statistics(response)
    ...
    def get_season_competitors_statistics(self, season_id: str):
        response = self._make_request(f"seasons/{season_id}/summaries")
        season_competitors_statistics = utils._format_season_competitors_statistics(response)
    ...
    def get_season_referees(self, season_id: str):
        response = self._make_request(f"seasons/{season_id}/summaries")
        season_referees = utils._format_season_referees(response)
    ...
    def get_season_ball_locations(self, season_id):
        response = self._make_request(f"seasons/{season_id}/summaries")
        season_ball_locations = utils._format_season_ball_locations(response)
    ...
    def get_season_channels(self, season_id):
        response = self._make_request(f"seasons/{season_id}/summaries")
        season_channels = utils._format_season_channels(response)
    ...
    def get_player_profile(self, player_id: str):
        ...
        player_profile = utils._format_player_profile(response)
